...
## 7. A Tweet's relevancy decreases over time

Like most social media platforms, older Tweets on Twtiter become less relavant over time.

More specifically, Tweets have a half-life of 360 minutes (6 hours), which means that a Tweet's relevancy score will decrease by 50% every 6 hours.
...
Source: [GitHub](https://dub.sh/tweet-decay-score)
