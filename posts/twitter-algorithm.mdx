...
## 7. Your Tweet's relevancy decreases over time
...
More specifically, Tweets have a half-life of 360 minutes, which means that **a Tweet's relevancy score will decrease by 50% every 6 hours**.
